...
class FirebaseService:
        ...
        try:
            ...
            if not firebase_admin._apps:
                ...
                if not cred_path.exists():
                    print(f"⚠️  Firebase credential file not found: {cred_path}")
                    print(f"🔄 Running without Firebase integration")
                    self.firebase_available = False
                    return
    ...
    def sync_sensor_data(self, sensor_data: Dict[str, Any]) -> bool:
        ...
        if not self.firebase_available:
            print("⚠️  Firebase not available - skipping sync")
            return False
        ...
        try:
            ...
            print("✅ Successfully synced sensor data to Firebase")
            return True
            
        except Exception as e:
            print(f"❌ Failed to sync sensor data to Firebase: {str(e)}")
            return False
