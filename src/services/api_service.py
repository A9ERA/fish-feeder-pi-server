...
class APIService:
    def __init__(self, host='0.0.0.0', port=5000, serial_service=None):
        ...
        self.feeder_service = FeederService(self.control_service, self.video_service, self.sensor_data_service)  # Initialize feeder service with sensor snapshot support
